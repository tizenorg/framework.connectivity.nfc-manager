...
#define NFC_LOGD(format, arg...) LOG(LOG_DEBUG,  net_nfc_get_log_tag(), "%s:%s(%d)>" format, __MODULE__, __func__, __LINE__, ##arg)
#define NFC_LOGE(format, arg...) LOG(LOG_ERROR,  net_nfc_get_log_tag(), "%s:%s(%d)>" format, __MODULE__, __func__, __LINE__, ##arg)
#define NFC_LOGI(format, arg...) LOG(LOG_INFO,  net_nfc_get_log_tag(), "%s:%s(%d)>" format, __MODULE__, __func__, __LINE__, ##arg)
